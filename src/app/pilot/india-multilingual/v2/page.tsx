...
async function getComparativeResults() {
  try {
    ...
    console.error('[v2/page.tsx] Failed to load comparative results:', error);
    return null;
  }
}
...
async function getSampleComparisons() {
  try {
    ...
    console.error('[v2/page.tsx] Failed to load sample comparisons:', error);
    return [];
  }
}
...
async function getRubricSummary() {
  try {
    ...
    console.error('[v2/page.tsx] Failed to load rubric summary:', error);
    return null;
  }
}
...
async function getOverlapWorkers() {
  try {
    ...
    console.error('[v2/page.tsx] Failed to load overlap workers:', error);
    return null;
  }
}

export default async function IndiaMultilingualV2Page() {
