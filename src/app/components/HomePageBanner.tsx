      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 md:flex md:space-x-6">
        <section aria-labelledby="prose-article" className="md:w-2/3">
          ...
          <p className="text-sm sm:text-base text-foreground/80 dark:text-slate-300/80 leading-relaxed max-w-3xl mx-auto mt-4">
            Weval is built to fill this exact gap. It audits the foundational prerequisites for responsible AI behavior, asking: Does a model have the essential knowledge of law and human rights, the situational awareness for sensitive contexts, and the resilience to manipulation required to earn public trust? By testing these core competencies, Weval provides a crucial leading indicator of an AI's fitness for civic life.
          </p>
        </section>
