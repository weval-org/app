...
export interface WorstPerformingEvaluation {
  configId: string;
  configTitle: string;
  runLabel: string;
  timestamp: string;
...
export interface ModelSummary {
  ...
  worstPerformingEvaluations?: WorstPerformingEvaluation[];
  ...
  analyticalSummary?: {
    // A concise, 1-2 sentence overview of the model's behavior and performance
    tldr?: string;
